<div id="main" class="container-fluid" style="margin-top: 50px">
    ...
    <div id="top" class="row">
        ...
        <div class="col-sm-6">
            <form action="<?= base_url('clientes/search') ?>" method="post">
                <div class="input-group h2">
                    <input name = "search" class = "form-control" id = "search" type = "text"
                           placeholder = "Pesquisar Clientes" value ="<?= $search ?>">
                ...
                <tbody>
                    <?php foreach ($rows as $row) { ?>
                        <tr>
                            ...
                            <td><?= $row['cpf'] ?></td>
                            <td class='actions'>
                                <a class='btn btn-success btn-xs' href="<?= base_url("clientes/view_simple/" . $row['id']) ?>">Visualizar</a>
                                <a class='btn btn-warning btn-xs' href="<?= base_url("clientes/edit/" . $row['id']) ?>">Editar</a>
